        ...
        <div className="flex items-center justify-between">
            <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 mt-1">
                    Pilotez les échanges internes de votre workspace
                </p>
            </div>
        </div>
    );
    ...
    const quickActions = [
        {
            ...
            description: "Structurer les échanges d'une équipe ou d'un sujet",
        ...
        },
        {
            ...
            description: "Contacter un collaborateur du workspace",
            ...
            <div className="space-y-6 p-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <Card className="lg:col-span-2 p-6 border border-gray-200 dark:border-gray-700">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Actions opérationnelles</h2>
                        ...
                        <div className="mt-6 p-6 bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg border border-primary/20">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-300">
                                Créez une salle par équipe, projet ou périmètre métier afin de garder les décisions et messages faciles à retrouver.
                            </p>
                        </div>
                    </Card>
                ...
                {topConversations.length > 0 && (
                    <Card className="p-6 border border-gray-200 dark:border-gray-700">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Conversations les plus actives</h2>
