...
export interface ChatCreationContextType {
...
const ChatCreationContext = createContext<ChatCreationContextType | undefined>(undefined);

export const useChatCreation = () => {
    const context = useContext(ChatCreationContext);
    if (!context) throw new Error('useChatCreation must be used within ChatCreationProvider');
    return context;
};
...
export default function ChatStepper({data, onClose}:StepperProps) {
    const [selectedUser, setSelectedUser] = useState<UserProps | null>(null);
    const [message, setMessage] = useState<string>("");
    const [roomId, setRoomId] = useState<string | null>(null);

    return (
        <ChatCreationContext.Provider value={{selectedUser, setSelectedUser, message, setMessage, roomId, setRoomId, onClose}}>
